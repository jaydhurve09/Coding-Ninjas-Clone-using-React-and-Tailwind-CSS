...
const Manager = () => {
    ...
    return (
        <>
            <div className=' relative bg-[#252525] bg-[radial-gradient(#ffffff33_1px,#00091d_1px)] bg-[size:20px_20px]'>
...
<div className="bg-slate-50">
                ...
                <div className='bg-[#f8f8ef] h-[1231px]'>
                    ...
                    <div className="flex">
                        <div className="w-72 h-[380px] rounded-lg overflow-hidden shadow-lg border border-[#e0c7bc] ml-72 mt-5">
                            ...
                            <div className="bg-slate-100 flex flex-col items-center h-80 gap-2  ">
                                ...
                                <h3 className="text-lg font-bold  p-3">PG Certification in Data Analytics with GenAI</h3>
                        ...
                        <div className="w-72 h-[380px] rounded-lg overflow-hidden shadow-lg border border-[#e0c7bc] ml-8 mt-5">
                            ...
                            <div className="bg-slate-100 flex flex-col items-center h-80 gap-2  ">
                                ...
                                <h3 className="text-lg font-bold  p-3">PG Certification in Full Stack Web Development with Generative AI</h3>
                    ...
                    <div className="flex">
                        <div className="w-72 h-[380px] rounded-lg overflow-hidden shadow-lg border border-[#e0c7bc] ml-72 mt-5">
                            ...
                            <div className="bg-slate-100 flex flex-col items-center h-80 gap-2  ">
                                ...
                                <h3 className="text-lg font-bold  p-3">Training and Internship Certification in Advanced DSA
                                </h3>
                                <span className="text-sm text-[#4f4642] rounded-e-full h-8 w-32 ml-[-122px] flex items-center justify-center bg-[#f8f7f5]">IITM Pravartak</span>
                            </div>
                        ...
                        <div className="w-72 h-[380px] rounded-lg overflow-hidden shadow-lg border border-[#e0c7bc] ml-8 mt-5">
                            ...
                            <div className="bg-slate-100 flex flex-col items-center h-80 gap-2  ">
                                ...
                                <h3 className="text-lg font-bold  p-3">Training and Internship Certification in Data Analytics
                                </h3>
                                <span className="text-sm text-[#4f4642] rounded-e-full h-8 w-52 ml-[-22px] flex items-center justify-center bg-[#f8f7f5]">E&ICT Academy, IIT Guwahati</span>
                            </div>
                        ...
                        <div className="w-72 h-[380px] rounded-lg overflow-hidden shadow-lg border border-[#e0c7bc] ml-8 mt-5">
                            ...
                            <div className="bg-slate-100 flex flex-col items-center h-80 gap-2  ">
                                ...
                                <h3 className="text-lg font-bold  p-3">Training and Internship Certification in Full Stack Web Development
